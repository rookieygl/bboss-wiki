...
而字段折叠的Java测试类则在[com/bboss/hellword/com.ygl.FieldCollapsing/FieldCollapsingTest](https://github.com/rookieygl/bboss-wiki/blob/master/src/test/java/com/bboss/hellword/com.ygl.FieldCollapsing/FieldCollapsingTest.java)
